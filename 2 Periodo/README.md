...
- Atividades desenvolvidas com fins acadêmicos
- Código representa evolução gradual do aprendizado em Java
- Algumas soluções podem ser refatoradas futuramente
